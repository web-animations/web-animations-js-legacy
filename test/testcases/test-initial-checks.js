timing_test(function() {
  ...
  at(0, function() {
    assert_styles("#text",{'color':'rgb(0, 0, 0)','fontSize':'16px','fontWeight':'normal','letterSpacing':'normal','lineHeight':'20px','textIndent':'0px','textShadow':'rgba(0, 0, 0, 0) 0px 0px 0px','wordSpacing':'0px'});
  }, "#text");
  at(1, function() {
    assert_styles("#background",{'backgroundColor':'rgba(0, 64, 0, 0.498039)'});
  }, "#background");
  at(1, function() {
    assert_styles("#border",{'borderBottomColor':'rgb(0, 128, 0)','borderBottomLeftRadius':'25px','borderBottomRightRadius':'25px','borderBottomWidth':'6px','borderLeftColor':'rgb(0, 128, 0)','borderLeftWidth':'6px','borderRightColor':'rgb(0, 128, 0)','borderRightWidth':'6px','borderTopColor':'rgb(0, 128, 0)','borderTopLeftRadius':'25px','borderTopRightRadius':'25px','borderTopWidth':'6px'});
  }, "#border");
  at(1, function() {
  ...
  at(1, function() {
    assert_styles("#outline",{'outlineColor':'rgb(0, 64, 0)','outlineWidth':'6px','outlineOffset':'5px'});
  }, "#outline");
  at(1, function() {
  ...
  at(1, function() {
    assert_styles("#text",{'color':'rgb(0, 64, 0)','fontSize':'23px','fontWeight':'bold','letterSpacing':'2px','lineHeight':'37px','textIndent':'25px','textShadow':'rgba(0, 128, 0, 0.498039) 5px 5px 25px','wordSpacing':'50px'});
  }, "#text");
  at(2, function() {
