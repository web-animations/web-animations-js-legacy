timing_test(function() {
  ...
  at(1, function() {
    assert_styles("#text",{'color':'rgb(0, 64, 0)','fontSize':'23px','fontWeight':'bold','letterSpacing':'5px','lineHeight':'36px','textIndent':'25px','textShadow':'rgba(0, 128, 0, 0.498039) 5px 5px 25px','wordSpacing':'100px'});
  }, "#text");
  at(2, function() {
